...
if (is_location_available(RoomChoices.PIZZERIA, Where.INSIDE_UPSTAIRS, RoomChoices.STORAGE)) {
	create_event_initialise_dialog_holder(id, partner_detective_3_dialog_content_init, partner_detective_3_dialog_resolver, partner_detective_3_default_choices(), "1");
	...
	create_event_initialise_dialog_holder(id, partner_detective_1_dialog_content_init, partner_detective_1_dialog_resolver, partner_detective_1_default_choices(), "3");
}
