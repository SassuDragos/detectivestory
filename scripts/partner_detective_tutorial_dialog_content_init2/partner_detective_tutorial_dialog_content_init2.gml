...
var dialog_body = ["You'll be able to find lots of items throughout our cases",
				"To use items on someone or something, drag it from the inventory, by pressing, holding and moving the mouse",
				"Try it by giving me that pack of cigarettes"];
var dialog_character = [obj_partner_detective,
					obj_partner_detective,
					obj_partner_detective];
var dialog_behaviour_sequence = [0,0,show_mouse_animation_3];
